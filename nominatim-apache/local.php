...
@define('CONST_Replication_Update_Interval', '3660');  // How often upstream publishes diffs
@define('CONST_Replication_Recheck_Interval', '3660'); // How long to sleep if no update found yet
